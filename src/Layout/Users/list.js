                  ...
                  <tbody>
                    {data && data.map((item, i) => (
                      <tr key={item.UserID }>
                        ...
                        <td><svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-x-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg" onClick={() => this.Delete(item.UserID)}>
