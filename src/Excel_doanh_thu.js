...
<section class="content">
          ...
          <div style={{float: 'right', width: '35%'}}>
                    <table>
                      ...
                      <tr style={{borderBottom: '1px solid white'}}>
                        ...
                        <td><b style={{textAlign: 'center', backgroundColor: '#35E17E', width: '200px', height: '60px' , display: 'inline-block'}}>d</b></td>
                      </tr>
                      <tr>
  ...
  <div class="ui grid middle aligned"  style={{overflow: 'auto', width: '100%', height:'600px'}}>
          ...
          <table id="example3" class="table table-bordered table-hover" style={{ fontSize: '14px' }}>
